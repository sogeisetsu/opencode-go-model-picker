...
> **关于本文件**
>
> 本文件是仓库根目录 [`LICENSE`](../LICENSE)（GNU GPL v3 英文原文）的**非官方简体中文参考译本**，仅供阅读、帮助理解，**不具法律效力**。具法律效力的唯一文本是英文原文；如有歧义，一律以英文原文为准。
>
> - 译者：阮坤良 <peterrk@pku.edu.cn>
> - 来源：GNU 官方「非官方翻译」列表（<https://www.gnu.org/licenses/translations.html>）所列简体中文（zh-cn）译本
> - 抓取日期：2026-09-11
> - 按 GNU 要求，本译本已标注为**非官方译本**；转载本译本（无论修改与否）须遵守 <https://www.gnu.org/licenses/translations.html> 的条款。
